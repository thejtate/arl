...
<div class="inner-wrapper">
  ...
  <div class="content-wrapper style-a">
    <div class="container">
      <div class="form form-quote">
        ...
        <div class="content-inner">
          ...
          <div class="form-item webform-component webform-component-radios webform-component--hear">
            ...
            <div id="edit-submitted-hear" class="form-radios">
              <div class="form-item form-type-radio form-item-submitted-hear">
                <input type="radio" id="edit-submitted-hear-1" name="submitted[hear]" value="web_search"
                       class="form-radio"> <label class="option" for="edit-submitted-hear-1">Web Search </label>

              </div>
              <div class="form-item form-type-radio form-item-submitted-hear">
                <input type="radio" id="edit-submitted-hear-2" name="submitted[hear]" value="association"
                       class="form-radio"> <label class="option" for="edit-submitted-hear-2">Association </label>

              </div>
              <div class="form-item form-type-radio form-item-submitted-hear">
                <input type="radio" id="edit-submitted-hear-3" name="submitted[hear]" value="tradeshow"
                       class="form-radio"> <label class="option" for="edit-submitted-hear-3">Tradeshow </label>

              </div>
              <div class="form-item form-type-radio form-item-submitted-hear">
                <input type="radio" id="edit-submitted-hear-4" name="submitted[hear]" value="advertisement"
                       class="form-radio"> <label class="option" for="edit-submitted-hear-4">Advertisement </label>

              </div>
              <div class="form-item form-type-radio form-item-submitted-hear">
                <input type="radio" id="edit-submitted-hear-5" name="submitted[hear]" value="referred_by"
                       class="form-radio"> <label class="option" for="edit-submitted-hear-5">Referred by </label>

              </div>
            </div>
            <div
              class="col-sm-4 form-item webform-component webform-component-textfield webform-component--association-name"
              style="display: block;">
              <label class="element-invisible" for="edit-submitted-association-name">Association name </label>
              <input placeholder="Association Name" type="text" id="edit-submitted-association-name"
                     name="submitted[association_name]" value="" size="60" maxlength="128" class="form-text">
            </div>
            <div class="col-sm-4 form-item webform-component webform-component-textfield webform-component--persons-name"
                 style="display: block;">
              <label class="element-invisible" for="edit-submitted-persons-name">Person's name </label>
              <input placeholder="Person's name" type="text" id="edit-submitted-persons-name"
                     name="submitted[persons_name]" value="" size="60" maxlength="128" class="form-text">
            </div>
          </div>
